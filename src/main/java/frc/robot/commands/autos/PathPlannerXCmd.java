...
public class PathPlannerXCmd extends SequentialCommandGroup{
    public PathPlannerXCmd(SwerveSubsystem swerveSubsystem, PathPlannerTrajectory traj){
        ...
        addCommands(
            ...
            new PIDController(0.75, 0.05, 0.3), // X controller. Tune these values for your robot. Leaving them 0 will only use feedforwards.
            new PIDController(0.05, 0.0, 0.), // Y controller (usually the same values as X controller)
