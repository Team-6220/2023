...
public class ChargingStationAuto extends CommandBase {
  ...
  public ChargingStationAuto(DrivetrainSubsystem drivetrain, double pitchOffsetDegrees, double rollOffsetDegrees) {
  ...
  public ChargingStationAuto(DrivetrainSubsystem drivetrain) {
